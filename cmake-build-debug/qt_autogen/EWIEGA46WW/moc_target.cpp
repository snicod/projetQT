...
QT_MOC_LITERAL(3, 16, 20), // "onMediaStatusChanged"
QT_MOC_LITERAL(4, 37, 25), // "QMediaPlayer::MediaStatus"
QT_MOC_LITERAL(5, 63, 6) // "status"

    },
    "Target\0clicked\0\0onMediaStatusChanged\0"
    "QMediaPlayer::MediaStatus\0status"
};
...
void Target::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Target::clicked)) {
                *result = 0;
                return;
            }
        }
